...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		var gaming:Bool = PlayState.SONG.song.toLowerCase() != 'greetings' && PlayState.SONG.song.toLowerCase() != 'viber';
		...
		if (gaming)
			...
			else
			{
					...
					portraitLeft.frames = Paths.getSparrowAtlas('blueyPort');
			...
			//if (PlayState.SONG.song.toLowerCase() != 'greetings'                                                                                                              :
		//		{
